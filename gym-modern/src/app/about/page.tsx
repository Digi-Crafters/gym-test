  ...
  const workoutPlans = [
    {
      ...
      price: "₹1,999",
      duration: "per month",
      features: ["Gym Access", "Basic Equipment", "Locker Facility", "Group Sessions"],
      popular: false,
      icon: FaHeart
    },
    {
      ...
      price: "₹3,999",
      duration: "per month", 
      features: ["Personal Trainer", "Nutrition Guidance", "Premium Equipment", "Spa Access", "24/7 Access"],
      popular: true,
      icon: FaBolt
    },
    {
      ...
      price: "₹5,999",
      duration: "per month",
      features: ["Dedicated Coach", "Custom Programs", "Recovery Sessions", "VIP Lounge", "Supplement Plan"],
      popular: false,
      icon: FaTrophy
    }
  ];
    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex items-center space-x-8">
              {['Home', 'Programs', 'Trainers', 'Pricing', 'Contact'].map((item, index) => (
                <motion.a
                  key={item}
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Experience the ultimate fitness revolution with cutting-edge equipment, expert guidance, and a community that pushes your limits every single day.
          </motion.p>
            ...
            {[
              ...
              >
                <div className="bg-gradient-to-r from-white/10 to-gray-300/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 group-hover:border-white/40 transition-all duration-300">
                  ...
                  <div className="text-gray-400 font-bold text-sm tracking-wide">{stat.label}</div>
                </div>
              </motion.div>
            ))}
          </motion.div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-5xl md:text-7xl font-black mb-4">
              ELITE <span className="bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">PROGRAMS</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto font-light">
              Scientifically designed programs that deliver real results for every fitness level
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Master the art of strength with progressive overload training and compound movements",
                image: "https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?w=500&h=400&fit=crop",
                features: ["Powerlifting Focus", "Progressive Overload", "Form Perfection"],
                gradient: "from-white/90 to-gray-300/90"
              },
              {
                title: "CARDIO INFERNO",
                description: "High-intensity cardiovascular training that burns fat and builds endurance", 
                image: "https://images.unsplash.com/photo-1571019613914-85e3dbf2b74a?w=500&h=400&fit=crop",
                features: ["HIIT Training", "Fat Burning", "Endurance Building"],
                gradient: "from-gray-200/90 to-white/90"
              },
              {
                title: "MIND & BODY",
                description: "Holistic wellness combining yoga, meditation, and flexibility training",
              ...
              },
              {
                ...
                description: "Real-world strength training with functional movement patterns",
                image: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=500&h=400&fit=crop",
                features: ["Functional Movement", "Core Stability", "Athletic Performance"],
                gradient: "from-white/90 to-gray-200/90"
              },
              {
                title: "PERSONAL ELITE",
                description: "One-on-one coaching with customized programming for maximum results",
                image: "https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=500&h=400&fit=crop",
                features: ["1-on-1 Coaching", "Custom Programs", "Nutrition Planning"],
                gradient: "from-gray-100/90 to-white/90"
              },
              {
                title: "GROUP DYNAMICS",
                description: "High-energy group classes that combine fitness with social motivation",
                image: "https://images.unsplash.com/photo-1518611012118-696072aa579a?w=500&h=400&fit=crop",
                features: ["Team Energy", "Social Motivation", "Varied Workouts"],
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  />
                  <div className={`absolute inset-0 bg-gradient-to-t ${program.gradient} opacity-0 group-hover:opacity-80 transition-opacity duration-500`}></div>
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-300 mb-4 font-light">{program.description}</p>
      ...
      <section id="trainers" className="py-20 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-5xl md:text-7xl font-black mb-4">
              MASTER <span className="bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">TRAINERS</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto font-light">
              Train with legends who have transformed thousands of lives across India
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                experience: "12+ Years",
                image: "https://images.unsplash.com/photo-1571019613914-85e3dbf2b74a?w=400&h=600&fit=crop",
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    ...
                    <p className="text-gray-300 font-bold">{trainer.specialty}</p>
                  </div>
                </div>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="text-gray-400 font-medium mb-2">Certifications</div>
      ...
      <section id="pricing" className="py-20 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-5xl md:text-7xl font-black mb-4">
              CHOOSE YOUR <span className="bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">POWER</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto font-light">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {workoutPlans.map((plan, index) => (
              ...
              >
                ...
                <button className={`w-full py-4 rounded-2xl font-black transition-all duration-300 ${
                  plan.popular 
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-5xl md:text-7xl font-black mb-4">
              SUCCESS <span className="bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">LEGENDS</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto font-light">
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 font-medium">{testimonial.location}</p>
                  </div>
                </div>
                ...
                <p className="text-gray-300 italic font-light text-lg leading-relaxed">"{testimonial.text}"</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section id="contact" className="py-20 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-5xl md:text-7xl font-black mb-4">
              BEGIN YOUR <span className="bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">LEGEND</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto font-light">
              Ready to forge your destiny? Connect with us and start your transformation today
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-gray-300 font-medium">456 Power Street, Delhi, India 110001</p>
                </div>
              </div>
            ...
            >
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-gray-300 mb-2 font-bold text-sm tracking-wide">FIRST NAME</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-gray-300 mb-2 font-bold text-sm tracking-wide">LAST NAME</label>
                  <input
                    type="text"
                    className="w-full bg-white/5 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-gray-400 focus:border-white/50 focus:outline-none focus:bg-white/10 transition-all duration-300"
              ...
              <div>
                <label className="block text-gray-300 mb-2 font-bold text-sm tracking-wide">EMAIL</label>
                <input
                  type="email"
                  className="w-full bg-white/5 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-gray-400 focus:border-white/50 focus:outline-none focus:bg-white/10 transition-all duration-300"
              ...
              <div>
                <label className="block text-gray-300 mb-2 font-bold text-sm tracking-wide">PHONE</label>
                <input
                  type="tel"
                  className="w-full bg-white/5 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-gray-400 focus:border-white/50 focus:outline-none focus:bg-white/10 transition-all duration-300"
              ...
              <div>
                <label className="block text-gray-300 mb-2 font-bold text-sm tracking-wide">FITNESS GOAL</label>
                <select className="w-full bg-white/5 border border-white/20 rounded-xl px-4 py-3 text-white focus:border-white/50 focus:outline-none focus:bg-white/10 transition-all duration-300">
                  ...
                  <option value="strength" className="bg-black">Build Strength</option>
                  <option value="weight-loss" className="bg-black">Lose Weight</option>
                  <option value="muscle-gain" className="bg-black">Gain Muscle</option>
                  <option value="endurance" className="bg-black">Improve Endurance</option>
                  <option value="wellness" className="bg-black">Overall Wellness</option>
                </select>
              </div>

              <div>
                <label className="block text-gray-300 mb-2 font-bold text-sm tracking-wide">MESSAGE</label>
                <textarea
                  rows={4}
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-300 mb-6 max-w-md font-light leading-relaxed">
                Forge your legend at India's most elite fitness destination. Where ordinary people become extraordinary warriors through relentless dedication and world-class training.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {['Strength Mastery', 'Cardio Inferno', 'Mind & Body', 'Personal Elite', 'Group Dynamics'].map((program) => (
                  <li key={program}>
            ...
            >
              ...
              <div className="aspect-video bg-gradient-to-br from-white/5 to-gray-300/5 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-300 font-light">Witness the power of IronCore</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
