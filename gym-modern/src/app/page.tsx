  ...
  const workoutPlans = [
    {
      ...
      price: "₹2,999",
      duration: "per month",
      features: ["Personal Trainer", "Equipment Access", "Nutrition Plan", "Progress Tracking"],
      popular: false
    },
    {
      ...
      price: "₹4,499",
      duration: "per month", 
      features: ["Personal Trainer", "Group Classes", "Nutrition Consultation", "Spa Access", "Progress Tracking"],
      popular: true
    },
    {
      ...
      price: "₹6,999",
      duration: "per month",
      features: ["Dedicated Trainer", "Custom Meal Plans", "Recovery Sessions", "24/7 Access", "Premium Supplements"],
      popular: false
    }
  ];
    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Join India's most advanced fitness center and unlock your potential with world-class equipment, expert trainers, and a supportive community.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-bold mb-4">
              Our <span className="bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">Programs</span>
            </h2>
            ...
            {[
              {
                ...
                features: ["Olympic Lifting", "Powerlifting", "Functional Training"]
              },
              {
                title: "Cardio & HIIT",
                description: "Burn fat and improve cardiovascular health with high-intensity workouts", 
                image: "https://images.unsplash.com/photo-1571019613914-85e3dbf2b74a?w=400&h=300&fit=crop",
              ...
              },
              {
                ...
                description: "Challenge yourself with varied, high-intensity functional movements",
                image: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=400&h=300&fit=crop",
                features: ["WOD Classes", "Olympic Lifting", "Metabolic Training"]
              },
              {
                title: "Personal Training",
                description: "Get one-on-one attention with customized workout plans",
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-bold mb-3 text-orange-500">{program.title}</h3>
      ...
      <section id="trainers" className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-bold mb-4">
              Expert <span className="bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">Trainers</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            {[
              {
                ...
                experience: "8+ Years",
                image: "https://images.unsplash.com/photo-1571019613914-85e3dbf2b74a?w=400&h=500&fit=crop",
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    ...
                    <p className="text-orange-500 font-semibold">{trainer.specialty}</p>
                  </div>
                </div>
                <div className="p-6">
                  <div className="flex justify-between items-center mb-4">
                    <span className="text-gray-300">Experience</span>
                    <span className="text-orange-500 font-semibold">{trainer.experience}</span>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {workoutPlans.map((plan, index) => (
              <motion.div
                key={index}
                className={`relative bg-gradient-to-b from-gray-800/50 to-gray-900/50 rounded-2xl p-8 ${plan.popular ? 'ring-2 ring-orange-500 scale-105' : ''}`}
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: index * 0.1 }}
                viewport={{ once: true }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div>
                <label className="block text-gray-300 mb-2 font-medium">Fitness Goals</label>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-300 mb-6 max-w-md">
                Transform your body and mind at India's premier fitness destination. Join thousands who have already started their journey to a healthier, stronger life.
              </p>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-4 text-orange-500">Programs</h3>
              <ul className="space-y-3">
                {['Strength Training', 'Cardio & HIIT', 'Yoga & Flexibility', 'Personal Training', 'Group Classes'].map((program) => (
                  <li key={program}>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex gap-6 text-sm">
                <a href="#" className="text-gray-400 hover:text-orange-500 transition-colors duration-300">Privacy Policy</a>
                <a href="#" className="text-gray-400 hover:text-orange-500 transition-colors duration-300">Terms of Service</a>
                <a href="#" className="text-gray-400 hover:text-orange-500 transition-colors duration-300">Cookie Policy</a>
              </div>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="aspect-video bg-gradient-to-br from-orange-500/20 to-red-500/20 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2">Our Fitness Journey</h3>
                  <p className="text-gray-300">Experience the transformation at FitForge</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
